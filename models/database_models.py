"""
Database models for storing counting data and sessions.
Soporta cultivos monoclonales (1 especie) y policlonales (múltiples especies)
"""
...
class Image(db.Model):
    ...
    culture_type = db.Column(db.String(50), default='unknown')  # 'monoclonal' or 'policlonal'
    num_species = db.Column(db.Integer, default=1)  # Número de especies (1 para monoclonal, 3 para policlonal)
...
class BatchImageCount(db.Model):
    ...
    manual_count = db.Column(db.Integer, nullable=False)  # Para monoclonal: total; para policlonal: suma de especies
    manual_count_species1 = db.Column(db.Integer, nullable=True)  # Especie 1
    manual_count_species2 = db.Column(db.Integer, nullable=True)  # Especie 2
    manual_count_species3 = db.Column(db.Integer, nullable=True)  # Especie 3
...
class AutomaticImageResult(db.Model):
    ...
    image_id = db.Column(db.Integer, db.ForeignKey('images.id'), nullable=False)
    count = db.Column(db.Integer, nullable=False)  # Para monoclonal: total; para policlonal: suma de especies
